...
func assetsTemplatesIndexHtml() (*asset, error) {
	...
	info := bindataFileInfo{name: "assets/templates/index.html", size: 126, mode: os.FileMode(420), modTime: time.Unix(1453574926, 0)}
...
func assetsTemplatesLayoutHtml() (*asset, error) {
	...
	info := bindataFileInfo{name: "assets/templates/layout.html", size: 859, mode: os.FileMode(420), modTime: time.Unix(1453574950, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
